...
public:
    PurePursuit() : Node("pure_pursuit_node")
    {
       ...
       // std::ifstream file("/home/nvidia/f1tenth_ws/src/lab-5-slam-and-pure-pursuit-team-10/pure_pursuit/src/sparse_straights_interpolated.csv"); //make sure to place this fil
        std::ifstream file("/home/nvidia/f1tenth_ws/src/lab-5-slam-and-pure-pursuit-team-10/pure_pursuit/src/sparse_straights_interpolated_my_favourite.csv"); //make sure to place this fil
